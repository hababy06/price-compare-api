...
const PriceCard = ({ 
  ...
  // List view
  return (
    <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 fade-in flex items-center p-6" style={{animationDelay: `${0.4 + index * 0.1}s`}}>
      {/* 商店資訊 */}
